...
const S = {
  ...
  sub: { fontSize: "13px", color: "#A1A1AA", textAlign: "center", marginBottom: "28px", lineHeight: "1.5" },
  ...
  return (
    <div style={S.page}>
      <div style={S.card}>
        ...
        {error && <div style={S.err} data-testid="forgot-error">{error}</div>}
        {success && <div style={S.success} data-testid="forgot-success">{success}</div>}
        ...
        {success && (
          <Link
            to="/reset-password"
            state={{ email }}
            style={{ display: "block", textAlign: "center", marginTop: "16px", padding: "12px", backgroundColor: "#0055FF", color: "#FFFFFF", borderRadius: "4px", fontFamily: "IBM Plex Sans, sans-serif", fontSize: "14px", fontWeight: "600", textDecoration: "none" }}
            data-testid="go-to-reset"
          >
            Enter Reset Code
          </Link>
        )}
        ...
        <p style={{ textAlign: "center", marginTop: "20px", fontSize: "13px", color: "#A1A1AA" }}>
          <Link to="/login" style={{ color: "#0055FF", textDecoration: "none", display: "inline-flex", alignItems: "center", gap: "4px" }}>
